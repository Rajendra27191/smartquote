...
.controller('SQManageServicesController',['$scope','$rootScope','$window','$anchorScroll','$log','$state','$timeout','SQUserHomeServices',function($scope,$rootScope,$window,$anchorScroll,$log,$state,$timeout,SQUserHomeServices){
