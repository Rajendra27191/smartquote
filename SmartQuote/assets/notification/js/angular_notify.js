angular.module('sq.SmartQuoteDesktop').value('cgNotifyTemplateName','angular-notify.html');
angular.module('sq.SmartQuoteDesktop').factory('notify',['$timeout','cgNotifyTemplateName','$http','$compile','$templateCache','$rootScope',
...
angular.module("sq.SmartQuoteDesktop").run(["$templateCache", function($templateCache) {
