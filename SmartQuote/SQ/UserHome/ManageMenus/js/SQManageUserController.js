...
$scope.form = {};
$scope.manageUser = {};
// $scope.manageUser.paymentReminderEmailFlag='NO';

$scope.isUserNameSelected = false;
$scope.isSaveConfirm = false;
...
"paymentReminderEmailFlag" : $scope.manageUser.paymentReminderEmailFlag,	
};
...
$scope.confirmPRFlag=function(){
var previousWindowKeyDown = window.onkeydown;
swal({
title: 'Please Confirm PR Email Flag',
text: "After confirmation this user will overwrite previous flagged user",
...
if ($scope.dateValid) {
if($scope.manageUser.paymentReminderEmailFlag.toUpperCase()=="YES"){
$scope.confirmPRFlag();
}else{
	if ($scope.buttonstatus == 'add') {
	console.log("ADD")
...
+ getTimeStamp(),
'paymentReminderEmailFlag' : userdata.paymentReminderEmailFlag,
};
